 ...
 */
@AwsLambdaWithGateway(name="AuthenticateUserApi", desc="Custom authentication service", handlerMethod="handleRequest", memorySize="512", timeout="60", resourceName="authenticate", method=AwsLambdaWithGateway.MethodTypes.POST, authorization=AwsLambdaWithGateway.AuthorizationTypes.NONE, keyRequired=false, enableCORS=true)
public class AuthenticateUserApi extends BaseLambdaHandler
{
    /**
     * 
     * @return
